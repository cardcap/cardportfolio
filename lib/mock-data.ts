...
export const portfolioAllocationBreakdown = [
  { label: "Seltene Karten", percent: 42, color: "#f472b6" },
  { label: "Foil Karten", percent: 18, color: "#a78bfa" },
  { label: "Full Art", percent: 12, color: "#67e8f9" },
  { label: "Andere", percent: 28, color: "#71717a" },
];
