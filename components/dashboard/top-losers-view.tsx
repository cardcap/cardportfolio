  ...
  return (
    <div className="pb-4">
      ...
      <div className="overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--surface)]">
        ...
        {/* Desktop header — compact cols, change on one line */}
  ...
  return (
    <li>
      ...
      >
        ...
        {/* Desktop — tight layout, change on one line with current value */}
        <div className="hidden items-center gap-2 xl:grid xl:grid-cols-[2rem_minmax(11rem,1.3fr)_minmax(6.5rem,0.9fr)_3.25rem_3rem_5.5rem_5.5rem_7.5rem_4.5rem_1.25rem]">
          ...
          <div className="flex items-baseline justify-end gap-1.5 self-center text-right">
            ...
            <span className="tabular-nums whitespace-nowrap text-[11px] font-medium leading-none text-[var(--negative)]">
              {delta}
            </span>
          </div>
