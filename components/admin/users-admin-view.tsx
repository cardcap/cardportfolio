      ...
      <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--muted)]">
            Konten, Rollen und Besitz-Übersicht
          </p>
        </div>
        <button
          type="button"
          onClick={() => void load()}
          className="self-start rounded-full border border-[var(--border)] px-3 py-1.5 text-xs text-[var(--muted)] hover:text-[var(--foreground)]"
        >
          Aktualisieren
        </button>
      </div>
