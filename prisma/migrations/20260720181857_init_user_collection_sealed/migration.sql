...
CREATE TABLE "SealedItem" (
    ...
    "language" TEXT NOT NULL DEFAULT 'DE',
    "condition" TEXT NOT NULL DEFAULT 'OVP',
    "quantity" INTEGER NOT NULL DEFAULT 1,
...
-- CreateIndex
CREATE INDEX "CollectionItem_userId_tcgCardId_idx" ON "CollectionItem"("userId", "tcgCardId");

-- CreateIndex
CREATE UNIQUE INDEX "CollectionItem_userId_tcgCardId_condition_key" ON "CollectionItem"("userId", "tcgCardId", "condition");

-- CreateIndex
CREATE INDEX "SealedItem_userId_idx" ON "SealedItem"("userId");

-- CreateIndex
CREATE INDEX "SealedItem_userId_productKey_idx" ON "SealedItem"("userId", "productKey");
